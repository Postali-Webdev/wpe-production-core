    ...
    <?php } ?>
        <div class="columns">
            ...
            <div class="column-66 block">
                ...
                <?php } elseif (is_page_template('page-practice-parent.php') || is_page_template('page-interior.php') || is_page_template('page-about.php')) { ?>
            ...
            <?php if(!is_post_type_archive('reviews') && !is_post_type_archive('results') ) { ?>
